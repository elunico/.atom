...
from screen import Screen, Color, Invert, Bold, Underline, TextStyle
...
def main():
    ...
    scr = curses_begin()
    scr.win.addstr('this is a string', TextStyle(0, (Color.named('part-of-speech'), )).attr())
    scr.win.addstr('this is a string', TextStyle(0, (Color.named('definition'), )).attr())
    scr.getch()
    curses.endwin()
    return
    show_banner(scr)
